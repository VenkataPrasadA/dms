...
<div class="card-header page-top">
		<div class="row">
			<div class="col-md-3 heading-breadcrumb">
				<h5 style="font-weight: 700 !important">FEEDBACK LIST</h5>
			</div>
			<div class="col-md-9 " >
...
<%
			...
			<div class="col-md-1"></div>
				<div class="col-md-10">
				 <div class="card shadow-nohover" >
					<div class="card-header" style="background-color:#C4DDFF; ">
							...
							<div class="col-md-8" >
								<table> 
										...
										<td style="width: 150px;">
											<select class="form-control selectpicker" id="ftype" name="feedbacktype" data-container="body" data-live-search="true"   style="font-size: 5px;" onchange="this.form.submit()">
								...
								<tr>
									...
									<%
										...
										%>
											...
											<button class="editable-click" type="button" name="sub" style="border: none;" value="Details"	onclick="ClosefeedbackmodalRemarks( '<%=obj[0]%>')">
										 ...
										 <%}else{  if(logintype.equalsIgnoreCase("A")){%>
											<button class="editable-click" type="button" name="sub" value="Details" style="border: none;"	onclick="Closefeedbackmodal( '<%=obj[0]%>','<%=obj[1]%>' , '<%=sdf1.format(inputFormatter.parse(obj[2].toString()) )%>')">
												<div class="cc-rockmenu">
														<div class="rolling">
														   <figure class="rolling_icon">
									...
									%>
										&nbsp;&nbsp;&nbsp;<a href="FeedbackAttachDownload.htm?attachid=<%=list.get(0)[1]%>" title="Download"><i class="fa fa-download" aria-hidden="true" style="width: 10px; font-size:1.5em; color: green;"></i></a>
									 <%}%>
									 </td>
								</tr>
								<%
			...
			<div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 53% !important;height: 45%;">
				<div class="modal-content" style="min-height: 45%;" >
				    <div class="modal-header" style="background-color: #114A86;">
				    	<h4 class="modal-title" id="model-card-header" style="color: white;">Close Feedback <!-- By <span id="feedby1"></span> --></h4>
	...
	<div class="modal fade" id="ClosefeedbackRemarks" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 53% !important;height: 45%;">
				<div class="modal-content" style="min-height: 45%;" >
				    <div class="modal-header" style="background-color: #114A86;">
				    	<h4 class="modal-title" id="model-card-header" style="color: white;"> Feedback Remarks<!-- By <span id="feedby1"></span> --></h4>
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white;" >
				          <span aria-hidden="true">&times;</span>
