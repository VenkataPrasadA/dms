...
<div class="card-header page-top">
		<div class="row">
			<div class="col-md-3 heading-breadcrumb">
				<h5 style="font-weight: 700 !important">EXTRANET MAIL LIST</h5>
			</div>
			<div class="col-md-9 " >
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb ">
				    ...
				    <li class="breadcrumb-item active">Extranet Mail  List </li>
				  </ol>
				</nav>
			</div>			
		</div>
...
List<DakMail> mailAll= (List<DakMail>) request.getAttribute("MailList");
...
<div id="spinner" class="spinner" style="display:none;">
	...
	<div class="row datatables" id="main">
   		...
   		<div class="col-md-12">
   			<form action="MailExtList.htm" method="POST" id="preview" style="background-color:#0e6fb6;  border-radius: 4px;">
			    <div class="row" >			    
				    <div class="col-md-10" > 
				    </div>
				    <div class="col-md-1">
				    ...
				    <div class="col-md-1">
					   <button class="btn btn-sm btn-info btnspin" formaction="MailExtRecieved.htm" type="submit" ><i class="fa fa-refresh" aria-hidden="true"></i></button>
				...
				<div class="card-body"> 
					<form action="DakInit.htm" method="POST">
								...
								<tbody>
									...
									<tr>
	                                    ...
	                                    <td style="text-align: center;width: 18%;">
		                                      ...
		                                      <%if(dto.getDakMailAttach().size()>0){
		                                      for(DakMailAttach atach:dto.getDakMailAttach()){ %>   
											  	<button style="font-size: 11px;" type="submit" formaction="DownloadMailAttach.htm" name="fileName" value="<%=atach.getAttachPath() %>" class="btn btn-sm icon-btn "  data-toggle="tooltip" data-placement="top" title="Download" ><img alt="attach" src="view/images/download1.png"> <%=atach.getAttachPath() %></button>
		                                      <br>
		                                      <%} }else{%>
		                                         Empty
		                                      <%} %>
	                                    ...
	                                    <td style="text-align: center;width: 3%;">
						                    <%if(dto.getIsMarked().equals("N")){%>
												<button style="font-size: 11px;" type="submit" class="btn btn-sm btn-success" name="dakMailId" value="<%=dto.getDakMailId() %>"  data-toggle="tooltip" data-placement="top" title="Mark" >
