...
<div class="card-header page-top">
		<div class="row">
			<div class="col-md-3 heading-breadcrumb">
				<h5 style="font-weight: 700 !important">INTRANET MAIL LIST</h5>
			</div>
			<div class="col-md-9 " >
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb ">
				    ...
				    <li class="breadcrumb-item active">Intranet Mail  List </li>
				  </ol>
				</nav>
			</div>			
		</div>
...
%>
	...
	<div class="row datatables" id="main">
   		...
   		<div class="col-md-12">
   			<form action="MailIntList.htm" method="POST" id="preview" style="background-color:#0e6fb6;  border-radius: 4px;">
			    <div class="row" >			    
				    <div class="col-md-10" > 
				    </div>
				    <div class="col-md-1">
				    ...
				    <div class="col-md-1">
					   <button class="btn btn-sm btn-info btnspin" formaction="MailIntRecieved.htm" type="submit" ><i class="fa fa-refresh" aria-hidden="true"></i></button>
								...
								<tbody>
									...
									<tr>
	                                    ...
	                                    <td style="text-align: center;width: 18%;">
										  ...
										  <button style="font-size: 11px;" type="submit" class="btn btn-sm icon-btn " formaction="DownloadMailAttach.htm" name="fileName" value="<%=atach.getAttachPath() %>" data-toggle="tooltip" data-placement="top" title="Download" ><img alt="attach" src="view/images/download1.png"> <%=atach.getAttachPath() %></button>
