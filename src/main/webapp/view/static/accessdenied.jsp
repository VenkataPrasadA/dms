...
<p>> <span>SOME PAGES ON THIS SERVER THAT YOU DO HAVE PERMISSION TO ACCESS</span>: [<a href="${pageContext.request.contextPath}">Home Page</a>...]</p><p>> <span>HAVE A NICE DAY SIR  :-)</span></p>
</div>
